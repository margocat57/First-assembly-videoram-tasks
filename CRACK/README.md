...
**Идея взлома** состоит в том, что при переполнении буфера можно дойти до расположенных дальше инструкций и изменить их.
...
В этой программе вводимые данные также помещаются в стек. При этом каждый следующий байт записывается по адресу, который больше предыдущего.
