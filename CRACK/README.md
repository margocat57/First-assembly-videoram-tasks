...
Код, формирующий последовательность байт для эксплуатации данной уязвимости, приведён в файле VZ1.CPP.
...
Код, формирующий последовательность байт для эксплуатации данной уязвимости, приведён в файле VZ2.CPP.
...
Код, производящий замену байт для успешного патчинга, приведён в файле PATCH.CPP.